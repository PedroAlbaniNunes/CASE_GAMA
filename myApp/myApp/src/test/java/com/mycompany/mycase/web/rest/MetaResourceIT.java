...
import static com.mycompany.mycase.domain.MetaAsserts.*;
...
import com.mycompany.mycase.repository.MetaRepository;
...
class MetaResourceIT {
    ...
    private static final Double DEFAULT_NOTA_ANTERIOR = 1D;
    private static final Double UPDATED_NOTA_ANTERIOR = 2D;

    private static final Double DEFAULT_VALOR = 1D;
    private static final Double UPDATED_VALOR = 2D;

    private static final AreaDoEnem DEFAULT_AREA = AreaDoEnem.LINGUAGENS_CODIGOS_E_SUAS_TECNOLOGIAS;
    private static final AreaDoEnem UPDATED_AREA = AreaDoEnem.CIENCIAS_HUMANAS_E_SUAS_TECNOLOGIAS;
    ...
    public static Meta createEntity() {
        return new Meta().notaAnterior(DEFAULT_NOTA_ANTERIOR).valor(DEFAULT_VALOR).area(DEFAULT_AREA);
    }
    ...
    public static Meta createUpdatedEntity() {
        return new Meta().notaAnterior(UPDATED_NOTA_ANTERIOR).valor(UPDATED_VALOR).area(UPDATED_AREA);
    }
    ...
    void getAllMetas() throws Exception {
        ...
        restMetaMockMvc
            ...
            .andExpect(jsonPath("$.[*].notaAnterior").value(hasItem(DEFAULT_NOTA_ANTERIOR)))
    ...
    void getMeta() throws Exception {
        ...
        restMetaMockMvc
            ...
            .andExpect(jsonPath("$.notaAnterior").value(DEFAULT_NOTA_ANTERIOR))
    ...
    void putExistingMeta() throws Exception {
        ...
        updatedMeta.notaAnterior(UPDATED_NOTA_ANTERIOR).valor(UPDATED_VALOR).area(UPDATED_AREA);
    ...
    void fullUpdateMetaWithPatch() throws Exception {
        ...
        partialUpdatedMeta.notaAnterior(UPDATED_NOTA_ANTERIOR).valor(UPDATED_VALOR).area(UPDATED_AREA);
