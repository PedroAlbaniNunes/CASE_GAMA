...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'facba0ad-3b17-43fd-ab3a-753a62d78837' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('a4426885-16fe-4b28-8964-9bcc1050b17c');
      cy.get(`[data-cy="name"]`).should('have.value', 'a4426885-16fe-4b28-8964-9bcc1050b17c');
