...
import { sampleWithRequiredData } from '../alunos.test-samples';
...
describe('Alunos Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.alunos()[0]).toEqual(expect.objectContaining({ id: 164 }));
  });

  describe('trackId', () => {
    it('Should forward to alunosService', () => {
      const entity = { id: 164 };
      jest.spyOn(service, 'getAlunosIdentifier');
      const id = comp.trackId(entity);
      expect(service.getAlunosIdentifier).toHaveBeenCalledWith(entity);
